...
function reselect(command) {
  return ["modalEditor.clearSelections", command];
}
...
module.exports = {
  // NOTE: Common keybindings (except for insert mode)
  "": {
    u: repeatable("undo"),
    U: repeatable("redo"),
    /* Mutli-cursor
    ...
    // Changes
    c: recordChange(["modalEditor.cut", "modalEditor.setInsertMode"]),
    i: recordChange("modalEditor.setInsertMode"),
    I: recordChange(["cursorLineStart", "modalEditor.setInsertMode"]),
    a: recordChange(["cursorRight", "modalEditor.setInsertMode"]),
    ...
    m: {
      ...
      i: {
        w: {
          command: [
            repeatable(reselect("cursorWordStartLeftSelect")),
            repeatable(reselect("cursorWordStartRightSelect")),
            repeatable("cursorLeftSelect"),
          ],
        },
      },
    },
  ...
  normal: {
    ...
    L: "workbench.action.nextEditor", // goto mode
    g: {
      h: "cursorLineStart",
      l: [
        "cursorLineEnd",
