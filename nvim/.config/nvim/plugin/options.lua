...
opt.mouse = nil                             -- disable mouse inside neovim
...
opt.guicursor = 'n-v-c-sm:block,' ..
    'ci-ve:ver25,' ..
    'i-r-cr-o:hor20,' ..
    'i:blinkwait1000-blinkoff400-blinkon300'; -- cursor style '_' in insert mode
...
opt.listchars:append("eol:↴") -- render eol as ↴ when list option is set
opt.listchars:append("tab:→ ") -- render tab as → when list option is set
opt.listchars:append("space:·") -- render space as · when list option is set
