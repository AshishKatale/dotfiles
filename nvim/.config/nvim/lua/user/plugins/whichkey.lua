...
local mappings = {
  ...
  q = {
    name = "QuickFix List",
    q = { "<cmd>Trouble document_diagnostics<cr>", "File Diagnostics" },
    Q = { "<cmd>Trouble workspace_diagnostics<cr>", "Workspace Diagnostics" },
...
which_key.register(CK_mappings, CK_opts)
